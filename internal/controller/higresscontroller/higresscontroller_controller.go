...
func (r *HigressControllerReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	...
	if instance.GetDeletionTimestamp() != nil {
		...
		if err := r.deleteIngressClass(ctx, instance, logger); err != nil {
			return ctrl.Result{}, err
		}
...
func (r *HigressControllerReconciler) deleteRBAC(ctx context.Context, instance *operatorv1alpha1.HigressController, logger logr.Logger) error {
	if !instance.Spec.RBAC.Enable || !instance.Spec.ServiceAccount.Enable {
		return nil
	}
...
func (r *HigressControllerReconciler) createIngressClass(ctx context.Context, instance *operatorv1alpha1.HigressController, logger logr.Logger) error {
	...
	return CreateOrUpdateClusterResource(ctx, r.Config, gatewayClassResource, gatewayclass, logger)
}
...
func (r *HigressControllerReconciler) deleteIngressClass(ctx context.Context, instance *operatorv1alpha1.HigressController, logger logr.Logger) error {
	...
	return DeleteClusterResource(ctx, r.Config, gatewayClassResource, gatewayclass, logger)
}
